<aside class="relative hidden h-screen overflow-y-scroll shadow-xl bg-sidebar w-[22rem] sm:block">
    <div class="p-6">
        <a href="/">
    ...
    <nav class="pt-3 text-base font-semibold text-black">
        <a href="{{route('dashboard')}}" class="{{ request()->is('dashboard') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('dashboard*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
        ...
        <a href="{{route('header')}}" class="{{ request()->is('header*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('header*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
        ...
        <div x-data="{ open: false }">
            ...
            <a href="{{route('blog')}}" class="{{ request()->is('blog*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('blog*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('teacher-staff')}}" class="{{ request()->is('teacher-staff*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('teacher-staff*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('nav-links')}}" class="{{ request()->is('nav-links*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('nav-links*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('total-siswa')}}" class="{{ request()->is('total-siswa*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('total-siswa*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('video')}}" class="{{ request()->is('video*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('video*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('document')}}" class="{{ request()->is('document*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="{{ request()->is('document*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
            ...
            <a href="{{route('export')}}" class="{{ request()->is('export*') ? 'active-nav-link' : '' }} flex items-center text-black  py-4 pl-6 nav-item'">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="{{ request()->is('export*') ? '#ffffff' : '' }}" viewBox="0 0 256 256">
