        ...
        <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" id="form_siswa" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select id="penghasilan" name="penghasilan" class="w-full p-2 border border-gray-300 rounded-md">
                    ...
                    <option value="Kurang dari Rp. 500.000" {{ old('penghasilan', $siswa->penghasilan ?? '') === 'Kurang dari Rp. 500.000' ? 'selected' : '' }}>
                        < Rp. 500.000</option>
            ...
            <div x-data="{ 
                ...
                <p class="p-4 text-xs text-center text-red-600 border border-red-600 rounded sm:text-sm">
