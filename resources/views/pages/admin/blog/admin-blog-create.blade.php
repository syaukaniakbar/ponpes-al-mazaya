<x-dashboard-layout>
    ...
    <div class="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-md">
        ...
        <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="content" class="block text-lg font-medium text-gray-800 mb-2">Description</label>
                <textarea
                    id="description"
                    name="description"
                    rows="6"
            ...
            <input class="block w-full text-2xl text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-100 focus:outline-none py-4 px-4" id="image" type="file" name="image" accept="image/*">
        ...
        <div x-data="{ show: true }"
            ...
            class="text-center p-4 mt-4 mb-4 text-sm text-green-800 bg-green-100 border border-green-300 rounded-md" role="alert">
            {{ session('success') }}
        </div>
        @endif
        @if ($errors->any())
