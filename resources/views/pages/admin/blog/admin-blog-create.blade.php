<x-dashboard-layout>
    ...
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-md shadow-md">
        <h2 class="mb-6 text-2xl font-bold text-gray-800">Buat Postingan</h2>
        @if(session('success'))
        ...
        <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data" onsubmit="submitForm()">
            ...
            <fieldset>
                <div class="flex items-center my-4">
                    ...
                    <label for="prestasi" class="block text-sm font-medium text-gray-900 ms-2">Prestasi</label>
                </div>
                <div class="flex items-center mb-4">
                    ...
                    <label for="umum" class="block text-sm font-medium text-gray-900 ms-2">Umum</label>
                </div>
                <div class="flex items-center mb-4">
                    <input
                        id="ilmiah"
                    ...
                    <label for="ilmiah" class="block text-sm font-medium text-gray-900 ms-2">Ilmiah</label>
                </div>
            </fieldset>
            ...
            <div x-data="{ imagePreview: null, handleFilePreview(event) {
                ...
                <p class="p-4 text-center text-white bg-red-600 rounded">thumbnail menggunakan format ; jpeg,png,jpg | max: 5mb | HD / Full HD</p>
