<x-dashboard-layout>
    ...
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-md shadow-md">
        ...
        <form action="{{ route('teacher-staff.update', $teacherStaff->id) }}" method="POST" enctype="multipart/form-data" onsubmit="submitForm()">
            @csrf
            @method('PUT')
            <div class="my-6">
            ...
            <div class="my-6">
                ...
                <input
                    ...
                    value="{{ old('joined_date', $teacherStaff->joined_date ?? '')}}">
            </div>
            <fieldset>
                <label>Status</label>
                <div class="flex items-center gap-4 my-4">
                    <div class="flex items-center">
                        <input
                            ...
                            {{ $teacherStaff->role == 'guru' ? 'checked' : '' }}>
                    ...
                    <div class="flex items-center">
                        <input
                            ...
                            value="staf"
                            class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300"
                            {{ $teacherStaff->role == 'staf' ? 'checked' : '' }}>
            ...
            <div x-data="{ imagePreview: null, handleFilePreview(event) {
                ...
                <template x-if="!imagePreview">
                    ...
                    <div class="mt-4">
                        <p class="mb-2 text-sm text-gray-600">Foto Guru/Staf:</p>
                        <div class="w-full mx-auto max-w-48">
                            <img src="{{ asset('storage/' . $teacherStaff->image_path) }}" alt="Thumbnail" class="object-cover w-full h-full aspect-[3/4] border-4 border-gray-200 rounded-lg shadow-lg">
                        </div>
                    </div>
                    @endif
                </template>
                ...
                <!-- New Image Preview -->
                <template x-if="imagePreview">
                    <div class="w-full mx-auto mt-4 max-w-48">
