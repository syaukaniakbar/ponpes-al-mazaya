<x-dashboard-layout>
    ...
    <div class="max-w-2xl p-6 mx-auto bg-white rounded-md shadow-md">
        ...
        <form action="{{ route('total-siswa.update', $navLink->id) }}" method="POST" enctype="multipart/form-data" onsubmit="submitForm()">
            @csrf
            @method('PUT')
            <div class="mb-6">
                ...
                <fieldset>
                    ...
                    <div class="flex items-center mb-4">
                        <input
                            ...
                            value="MA"
                            class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300"
                            {{ old('tingkatan', $navLink->tingkatan) == 'MA' ? 'checked' : '' }}>
                    ...
                    <div class="flex items-center mb-4">
                        <input
                            ...
                            value="Santri Pondok"
                            class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300"
                            {{ old('tingkatan', $navLink->tingkatan) == 'Santri Pondok' ? 'checked' : '' }}>
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    value="{{ old('total_siswa', $navLink->total_siswa ?? '') }}">
            </div>
            <div class="mb-6">
