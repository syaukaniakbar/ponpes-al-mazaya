            ...
            <table class="min-w-full bg-white table-auto">
                <thead>
                    <tr class="text-white bg-gray-800">
                        ...
                        <th class="px-4 py-3 text-sm font-semibold text-left uppercase">Link Name</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-3">{{ $navLink->name }}</td>
                        <td class="px-4 py-3">{{ Str::limit($navLink->content, 100) }}</td>
                        <td class="px-4 py-3">{{ $navLink->created_at->format('d/m/Y') }}</td>
                        <td class="px-4 py-3">
                            <a href="{{ route('nav-links.edit', $navLink->id) }}" class="block w-full p-2 mb-2 text-center text-white bg-blue-600 rounded">
                                Edit
                            </a>
                            <form action="{{ route('nav-links.delete', $navLink->id) }}" method="post">
                                @csrf
                                @method('delete')
