<x-main-layout>
            ...
            <div class="flex h-full transition-transform duration-700 ease-out"
                ...
                <div class="relative flex-shrink-0 w-full h-full">
                    ...
                    <div class="absolute top-0 left-0 flex flex-col items-start justify-center w-full h-full text-white bg-black p-7 lg:p-28 bg-opacity-70">
                        ...
                        <a href="{{ route('pendaftaran') }}" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-green-600 rounded-lg hover:text-white hover:bg-green-600">
                            Daftar Sekarang
                        </a>
                    </div>
                </div>
    ...
    <!-- Guru dan staff -->
    <section class="bg-green-800 staff">
        <div class="grid max-w-screen-xl px-4 py-16 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            ...
            <div class="mx-auto text-center place-self-center lg:col-span-12">
                ...
                <p class="mb-8 text-sm text-white">
            ...
            <div class="lg:col-span-12">
                <div class="grid justify-center grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">

                    <div class="p-8 bg-gray-200 rounded-lg shadow-md text-start">
                        <img src="{{ asset('images/asset-berita.png') }}" alt="ponpes-al-mazaya-highlight" class="w-full max-w-md mb-6 rounded-md">
                        <div class="p-2 bg-white border-white rounded-lg">
                            <h3 class="mb-2 text-xl font-bold">Alifudin Rahman</h3>
                            <p>Guru Tajwid</p>
                        </div>
                    </div>
                    ...
                    <div class="p-8 bg-gray-200 rounded-lg shadow-md text-start">
                        <img src="{{ asset('images/asset-berita.png') }}" alt="ponpes-al-mazaya-highlight" class="w-full max-w-md mb-6 rounded-md">
                        <div class="p-2 bg-white border border-white rounded-lg">
                            <h3 class="mb-2 text-xl font-bold">Alifudin Rahman</h3>
                            <p>Guru Fiqih</p>
                        </div>
                    </div>
    ...
    <section class="p-6 news md:p-12 lg:p-24">
        ...
        <div class="grid max-w-screen-xl grid-cols-1 gap-8 px-4 mx-auto sm:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="relative flex flex-col overflow-hidden transition-transform duration-300 transform bg-white rounded-lg shadow-md hover:scale-105">
                <!-- Image -->
                <a href="{{ route('blog.show', ['slug' => $blog->slug]) }}" class="relative block group">
                ...
                <div class="flex flex-col flex-grow p-5">
                    <!-- Title -->
                    <a href="{{ route('blog.show', ['slug' => $blog->slug]) }}" class="mb-2 text-lg font-bold text-gray-800 transition hover:text-green-600">
                        {{ $blog->title }}
                    </a>
